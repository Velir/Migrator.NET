...
namespace Migrator
{
	...
	public class Migrator
	{
		...
		public Migrator(string provider, string connectionString, int commandTimeout, Assembly migrationAssembly)
			: this(provider, connectionString, commandTimeout, migrationAssembly, false)
		{
		}

		public Migrator(string provider, string connectionString, int commandTimeout, Assembly migrationAssembly, bool trace)
			: this(ProviderFactory.Create(provider, connectionString, commandTimeout), migrationAssembly, trace)
		{
		}

		public Migrator(string provider, string connectionString, int commandTimeout, Assembly migrationAssembly, bool trace, ILogger logger)
			: this(ProviderFactory.Create(provider, connectionString, commandTimeout), migrationAssembly, trace, logger)
		{
		}

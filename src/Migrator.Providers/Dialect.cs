...
namespace Migrator.Providers
{
	...
	public abstract class Dialect
	{
		...
		public abstract ITransformationProvider GetTransformationProvider(Dialect dialect, string connectionString, int commandTimeout);

		public ITransformationProvider NewProviderForDialect(string connectionString, int commandTimeout)
		{
			return GetTransformationProvider(this, connectionString, commandTimeout);
		}

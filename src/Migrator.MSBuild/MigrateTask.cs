...
namespace Migrator.MSBuild
{
	...
	/// </example>
	/// 
	/// Note that the Migrate task can also accept an optional attribute of CommandTimeout, which
	/// defines the length of time, in seconds, that is used for all database command timeouts.
